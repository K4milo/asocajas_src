...
<section id="respond">
  ...
  <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="author" id="author" placeholder="<?php _e('Nombre completo', 'bst'); ?>" value="<?php echo esc_attr($comment_author); ?>" <?php if ($req) echo 'aria-required="true"'; ?>>
    </div>
    <div class="form-group">
      <label for="email"><?php _e('Correo electrónico', 'bst'); if ($req) echo ' <span class="text-muted">' . _e('*', 'bst') . '</span>'; ?></label>
    ...
    <div class="form-group">
      <label for="url"><?php echo __('Website', 'bst') . ' <span class="text-muted">' . __('Opcional', 'bst') . '</span>'; ?></label>
